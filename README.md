...
The following arguments are available by running `docker run -it drewkerrigan/traefik-mesos traefik --help`
...
-l, --loglevel                                 Log level
    ...
    --tracing.backend                          Selects the tracking backend ('jaeger','zipkin').                                (default "jaeger")
